...
#
# Usage: ./scripts/memory_profile_dpo.sh <batch_size> <grad_accum> <seq_len> [model]
#
# Example:
#   ./scripts/memory_profile_dpo.sh 1 1 1024
#   ./scripts/memory_profile_dpo.sh 4 4 1024 Qwen/Qwen2.5-1.5B
#
# DPO uses ~1.3x memory of SFT (policy + frozen reference model)
...
echo "========================================"
echo ""
echo "NOTE: DPO uses ~1.3x memory of SFT (policy + reference)"
echo ""

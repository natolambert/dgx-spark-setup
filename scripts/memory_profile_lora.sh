...
#
# Usage: ./scripts/memory_profile_lora.sh <batch_size> <grad_accum> <seq_len> [model] [lora_rank]
#
# Example:
#   ./scripts/memory_profile_lora.sh 8 1 1024
#   ./scripts/memory_profile_lora.sh 16 4 2048 Qwen/Qwen2.5-1.5B 64
#
